...
<header>
    <nav class="navbar">
        ...
        <ul class="navbar-menu">
            <li><a href="?page=add_menu" class="<?php echo $page === 'add_car' ? 'active' : ''; ?>">Tambah Menu</a></li>
            <li><a href="?page=menu_list" class="<?php echo $page === 'car_list' ? 'active' : ''; ?>">Daftar Menu</a></li>
